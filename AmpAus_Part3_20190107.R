...
# tabulate 
#other
r4180 <- subset(a4180,Variant == "other")
nrow(r4180)
length(names(table(r4180$Adjective)))

r2640 <- subset(a2640,Variant == "other")
nrow(r2640)
length(names(table(r2640$Adjective)))

r1725 <- subset(a1725,Variant == "other")
nrow(r1725)
length(names(table(r1725$Adjective)))

#really
r4180 <- subset(a4180,Variant == "really")
nrow(r4180)
length(names(table(r4180$Adjective)))

r2640 <- subset(a2640,Variant == "really")
nrow(r2640)
length(names(table(r2640$Adjective)))

r1725 <- subset(a1725,Variant == "really")
nrow(r1725)
length(names(table(r1725$Adjective)))

#so
r4180 <- subset(a4180,Variant == "so")
nrow(r4180)
length(names(table(r4180$Adjective)))

r2640 <- subset(a2640,Variant == "so")
nrow(r2640)
length(names(table(r2640$Adjective)))

r1725 <- subset(a1725,Variant == "so")
nrow(r1725)
length(names(table(r1725$Adjective)))

#very
r4180 <- subset(a4180,Variant == "very")
nrow(r4180)
length(names(table(r4180$Adjective)))

r2640 <- subset(a2640,Variant == "very")
nrow(r2640)
length(names(table(r2640$Adjective)))

r1725 <- subset(a1725,Variant == "very")
nrow(r1725)
length(names(table(r1725$Adjective)))
